...
After the wP vaccination roll-out, the number of cases dramatically declined. After the aP vaccine, there was a rise in cases. A possible explanation for this could be people were more hesitant to get vaccinated. Another explanation could be that there is better technology to diagnose whooping cough, so you see a rise in diagnoses as compared to before the better technology. 

The effectiveness of the aP vaccination decreases, which is why there are booster shots for it. 
...
THey make their data available as a JSON format API. We cna read this into R with the `read_json()` function from the **jsonlite** package:
...
This is not representative of the US population, most of the subjects are white or asian. 
...
> Q. Is there are difference for these responses between aP and wP individuals?
