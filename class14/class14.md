...
- [Setup for and Run DESeq](#setup-for-and-run-deseq)
...
1:1 correspondence with `colData` rows. \> Q. Complete the code to
...
```
    ...
    Info: Working in directory /Users/kianabohanon/Desktop/BIMM143/bimm143_github/class14
...
![](hsa04142.pathview.png) ![](hsa00140.pathview.png)
...
has an online software available and R package available.
...
The cell cycle has the most signficant “Entities p-value”. This matches
the top 5 down-regulated pathways. The differences between the two
methods could be the way that the analysis was done, whether it was
different platforms or different data.
