...
Every time we want to use one of these “add-on” packages, we need to
...
Let’s “facet” (i.e. make a separate plot) by continent rather than being
the big hot mess above.
