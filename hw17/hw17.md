# Homework Class 17: Downstream Analysis
...
We can use R and Bioconductor tools to further explore this large scale
data-set.
...
![](hw17_files/figure-commonmark/unnamed-chunk-8-1.png)
...
This ggplot makes it clear that PC1 separates the control samples
(SRR2156848 and SRR2156849) from the two enhancer-targeting samples
(SRR2156850 and SRR2156851), implying that there are significant
